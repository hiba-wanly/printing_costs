...
part 'user_printer_model.g.dart';
...
// }
  ...
  Map<String,dynamic> toJson(){
    return{
      ...
      "printer_wear_and_tear":Printer_wear_and_tear,
      "depreciation_in_hours":depreciation_in_hours,
      // "courier_depreciation": this.courier_depreciationP,//courier_depreciation(),
      "inverter_and_battery_wear":inverter_and_battery_wear,
      "kilowatts_old":kilowatts_old,
      ...
      "electricity_courier":Electricity_courier,
  ...
  UserPrinters.fromJson(Map<String ,dynamic> json) {
    id = json['id'];
