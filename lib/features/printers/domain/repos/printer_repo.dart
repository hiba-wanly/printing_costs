...
abstract class PrinterRepo{
  ...
  Future<Either<ServerFailure,List<UserPrinters>>> updatePrinterList(Map<String,dynamic> data2,int id);
  Future<Either<ServerFailure,List<UserPrinters>>> deletePrinterList(int id);
